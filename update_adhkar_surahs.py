code = '''package com.example.data.adhkar
...
with open("app/src/main/java/com/example/data/adhkar/AdhkarModel.kt", "w") as f:
    f.write(code)

print("Updated AdhkarModel.kt successfully")
